    ...
    <nav className="navbar mb-2 shadow-lg bg-white text-neutral-content fixed top-0 inset-x-0 z-50">
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex md:items-center md:space-x-4">
          <Link
            to="/dashboard"
            className="text-base px-4 py-2 font-medium text-gray-500"
          >
      ...
      <div className="container mx-auto px-6 md:hidden bg-white fixed bottom-0 inset-x-0 z-50">
        <div className="py-4 flex justify-between">
          <Link to="/dashboard" className="flex flex-col items-center justify-center text-base font-medium text-gray-500">
            <FaHome className="inline text-2xl" />
          </Link>
          <Link to="/dashboard/about" className="flex flex-col items-center justify-center text-base font-medium text-gray-500">
            <FaSignal className="inline text-2xl" />
          </Link>
          <Link to="/dashboard/story" className="flex flex-col items-center justify-center text-base font-medium text-gray-500">
            <FaBook className="inline text-2xl" />
          </Link>
          <Link to="/dashboard/works" className="flex flex-col items-center justify-center text-base font-medium text-gray-500">
            <FaLightbulb className="inline text-2xl" />
          </Link>
          <Link to="/dashboard/community" className="flex flex-col items-center justify-center text-base font-medium text-gray-500">
